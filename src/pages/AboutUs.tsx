...
export default function AboutUs() {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-start">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-semibold text-gray-900 leading-tight">
              Mendampingi Perempuan Tumbuh Berdaya di Era Digital
            </h1>
          </div>
          
          {/* Right Side - Description */}
          <div className="space-y-4 sm:space-y-6 text-gray-700 leading-relaxed ml-0 sm:ml-8 lg:ml-16">
      ...
      <div className="bg-[#ffb4bc] py-12 sm:py-16 lg:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-start">
            ...
            <div className="relative">
              ...
              <div className="absolute left-4 sm:left-6 w-1 h-4/5 bg-white top-4"></div>
      ...
      {/* Footer Section */}
      <footer className="bg-white py-8 sm:py-10 lg:py-12 mx-4 sm:mx-8 lg:mx-12 mt-8 sm:mt-12 lg:mt-16 mb-6 sm:mb-8 lg:mb-12 rounded-2xl sm:rounded-3xl">
        <div className="max-w mx-auto">
          <div className="flex flex-col md:flex-row items-start px-4 sm:px-6">
            <div className="w-full md:w-1/4 mb-4 sm:mb-3 md:mb-0">
              <img src={Logo} className="w-32 sm:w-36 lg:w-40 mb-3 ml-0 sm:ml-3"/>
              <div className="mb-4 sm:mb-6">
                <h3 className="mb-3 sm:mb-4 text-sm sm:text-base text-gray-800"><span className="font-semibold">Corporate Head Office</span>: 3787 Jerry Dove Drive, Florence, South Carolina, 29501, United States.</h3>
            ...
            <div className="w-full justify-end ml-auto md:w-2/4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
              <div>
          ...
          <div className="px-4 sm:px-6 flex flex-col sm:flex-row justify-between items-start">
            <p className="text-sm sm:text-base text-gray-600">©2024 All rights reserved</p>
            
            {/* Social Media Icons */}
            <div className="flex space-x-3 sm:space-x-4 mt-8 sm:mt-12 lg:mt-16">
              <a href="#" className="text-gray-600 hover:text-[#EF0753] transition-colors">
