...
export default function Footer() {
  return (
    <footer className="bg-white py-4 sm:py-4 md:py-6 lg:py-8 mx-4 sm:mx-6 md:mx-8 lg:mx-12 mt-8 sm:mt-12 lg:mt-16 mb-4 sm:mb-5 md:mb-7 lg:mb-12 rounded-2xl sm:rounded-3xl">
